    ...
    *cur_pos += extra_len;
    ...
    if (**cur_pos == '(') {
        ...
        *cur_pos += extra_len;
        ...
        //CHECK_FUNC(get_new_Bin_tree_node, dest, nullptr, nullptr, EXPRESSION_LITERAL_TYPE, expression_val{});
        *dest = get_new_Bin_tree_node(nullptr, nullptr, EXPRESSION_LITERAL_TYPE, expression_val{}, &cur_err);
...
static errno_t read_T(Bin_tree_node **const dest, char const **const cur_pos) {
    ...
    while (**cur_pos == '*' or **cur_pos == '/') {
        if (**cur_pos == '*') {
            *dest = get_new_Bin_tree_node(*dest, nullptr,
                                          EXPRESSION_OPERATION_TYPE,
